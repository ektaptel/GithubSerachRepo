...
import  com.example.githubsearchrepo.api.models.GetRepos
import  com.example.githubsearchrepo.utils.KeyboardUtils
...
class HomePresenterImpl(private var context: Context) : HomePresenter {
    ...
    private fun getReposService() {
        ...
        GithubApplication.invoke().getRepos(searchText, sortBy, orderBy, pageLength, pageNum).enqueue(object: Callback<GetRepos> {
